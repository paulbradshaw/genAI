...
* [LM Studio](https://lmstudio.ai/), [AnythingLLM](https://anythingllm.com/) and [Ollama](https://ollama.com/) allow you to download and run LLMs locally including Llama, DeepSeek, Qwen and Gemma
